...
public class PhotoView extends AppCompatImageView implements IPhotoView {
    ...
    public DispatchTouchEventCallback mDispatchTouchEventCallback;

    @Override
    public boolean dispatchTouchEvent(MotionEvent event) {
        if(mDispatchTouchEventCallback != null){
            mDispatchTouchEventCallback.onEvent(event);
        }
    ...
    public void setImageViewMatrix(Matrix finalRectangle){
        mAttacher.setImageViewMatrix(finalRectangle);
    }
