 ...
 * <br />
 * enhance_sharpness: from -4.0 to 4.0, with 0.0 as the normal level
 */
public class GPUImageSharpenFilter extends GPUImageFilter {
    public static final String SHARPEN_VERTEX_SHADER = "" +
            ...
            "uniform float enhance_sharpness;\n" +
            "\n" +
            ...
            "    \n" +
            "    centerMultiplier = 1.0 + 4.0 * enhance_sharpness;\n" +
            "    edgeMultiplier = enhance_sharpness;\n" +
            "}";
    ...
    public void onInit() {
        super.onInit();
        mSharpnessLocation = GLES20.glGetUniformLocation(getProgram(), "enhance_sharpness");
