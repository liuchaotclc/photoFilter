...
package com.temp.cam.camerasdk.view.holocolorpicker;
...
public class SVBar extends View {
	...
	private static final String STATE_SATURATION = "enhance_saturation";
	...
	/**
	 * Set the pointer on the bar. With the enhance_saturation value.
	 * 
	 ...
	 * 
	 * @see com.temp.cam.camerasdk.view.holocolorpicker.ColorPicker#addSVBar(SVBar)
	 * @param picker
	 */
